  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-lime-500 tracking-widest">
          {category}
        </h2>
        <h1 className="text-lime-900 text-3xl title-font font-medium mb-1">
          {name}
        </h1>
        <div className="flex mb-4">
          <span className="flex items-center">
            ...
            <span className="text-lime-600 ml-3">4 Reviews</span>
          </span>
          <span className="flex ml-3 pl-3 py-2 border-l-2 border-lime-200 space-x-2s">
        ...
        <div className='p-3 font-serif text-black'>Seller : {seller}</div>
        <p className="leading-relaxed font-robo">
          {description}
        </p>
