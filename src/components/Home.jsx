  ...
  return (
    <>
            ...
            <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-lime-100 text-lime-500 mb-4 flex-shrink-0">
              ...
              <div className="flex-grow pl-6">
                ...
                <p className="leading-relaxed text-base">
                  ...
                  eveniet natus necessitatibus aut nesciunt similique provident
                  asperiores ipsa eum minima, temporibus tempore, sed veniam
                  accusantium, nemo voluptates deserunt consequatur tenetur.
                </p>
              </div>
            </div>
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="flex-grow pl-6">
                ...
                <p className="leading-relaxed text-base">
                  ...
                  Deleniti, nisi nostrum quibusdam id eligendi molestiae.
                  Asperiores earum dicta praesentium hic dolor quam, quasi est,
                  deleniti possimus impedit nulla ipsum itaque.
                </p>
              </div>
            </div>
            <div className="p-4 md:w-1/3 flex">
              ...
              <div className="flex-grow pl-6">
                ...
                <p className="leading-relaxed text-base">
                  ...
                  eius atque minus enim inventore minima, soluta molestiae
                  veritatis distinctio reprehenderit corrupti doloribus unde
                  assumenda. Atque tempora nulla aspernatur inventore?
                  Accusamus.
                </p>
              </div>
            </div>
      ...
      <section className="text-lime-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <h1 className="text-3xl font-medium title-font text-lime-900 mb-12 text-center">
            Testimonials
          </h1>
